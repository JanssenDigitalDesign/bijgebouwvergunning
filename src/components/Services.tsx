...
import { SmallHouseIcon, RulerPencilIcon, ShieldCheckIcon, FileCheckIcon } from "@/components/icons";

const ICONS = [SmallHouseIcon, RulerPencilIcon, ShieldCheckIcon, FileCheckIcon];
