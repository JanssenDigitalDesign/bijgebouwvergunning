...
export default async function OverOnsPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Over ons"
        h1="Gespecialiseerd in vergunningtekeningen voor bijgebouwen"
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <Reveal delay={100} className="mt-8 space-y-5 text-brand-ink-muted">
            <p>
              ...
              zich specifiek richt op vergunningtekeningen voor tuinhuizen, schuren en andere
              bijgebouwen.
            </p>
            <p>
              Die specialisatie maakt het verschil: het verschil tussen vergunningvrij en
              vergunningplichtig zit vaak in details als de afstand tot de achtergevel, de
              maximale hoogte en of het bijgebouw een ondergeschikte functie heeft ten opzichte
              van de woning. Doordat we dagelijks met dit type project werken, weten we precies
              waar een toetser op let en waar een
